...
test('Migra datos existentes sin perder nombres, horarios ni resultados y es idempotente',()=>{
 ...
 assert.deepEqual(old,snapshot);assert.equal(migrated.schemaVersion,3);assert.equal(migrated.revision,7);
